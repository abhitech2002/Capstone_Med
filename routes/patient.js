...
patientRouter.put("/:id", validationCheck, (req, res) => {
...
patientRouter.get("/:id", (req, res) => {
  ...
  Patient.findById(patientId)
    .then((patient) => {
      ...
      res
        .status(200)
        .json({ message: "Data fetch successfuuly.", data: patient });
    })
    .catch((error) => {
      res
        .status(500)
        .json({ message: "Data not fetch successfuuly", error: error.message });
    });
});
